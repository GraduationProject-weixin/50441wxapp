...
# 50441wxapp语言课学习系统的设计与实现小程序

![picture](https://raw.githubusercontent.com/GraduationProject-springboot/.github/main/img/wx.png)

### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV1NvtMeFEiw?p=101)
...
## 1.2 课题意义 
现如今，信息种类变得越来越多，信息的容量也变得越来越大，这就是信息时代的标志。近些年，计算机科学发展得也越来越快，而且软件开发技术也越来越成熟，因此，在生活中的各个领域，只要存在信息管理，几乎都有计算机的影子，可以说很多行业都采用计算机的方式管理信息。信息计算机化处理相比手工操作，有着保密性强，效率高，存储空间大，成本低等诸多优点。针对高校教师成果信息管理，采用语言课学习系统可以有效管理，使信息管理能够更加科学和规范。

总之，在实际中使用语言课学习系统，其意义如下：

第一点：语言课学习系统的实际运用，可以帮助管理人员在短时间内完成信息处理工作；
...
第四点：可以降低信息管理成本；
## 1.3 研究内容
对语言课学习系统设计制作，不仅需要技术支撑，也需要大量的理论研究。本文在对语言课学习系统进行介绍时，将按照如下内容进行。

第一部分：介绍语言课学习系统研究的背景意义，便于用户了解系统；

第二部分：介绍开发语言课学习系统需要搭建的环境，包括技术和工具；

第三部分：介绍用户对语言课学习系统的功能要求，以及对语言课学习系统的性能要求等；
...
# 第2章 开发环境与技术
语言课学习系统的编码实现需要搭建一定的环境和使用相应的技术，接下来的内容就是对语言课学习系统用到的技术和工具进行介绍。
## 2.1 MYSQL数据库
...
### 3.1.2 经济可行性
本系统开发期间需要配置的软件环境，可以免费通过开发类官网下载安装，需要配置的硬件设备也不需要具备很高的性能，通常网吧电脑，或学校计算机机房的电脑都符合要求。因此，从经济方面考虑，语言课学习系统开发可行。
### 3.1.3 操作可行性
语言课学习系统根据用户使用习惯进行开发，设计的界面具有统一性，并具备优秀的导航功能。所以，只要会简单操作电脑的人员，可以无压力操作语言课学习系统。
...
![C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\学习足迹.jpg](/md/blog.009.jpeg "C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\学习足迹.jpg")
学习足迹实体属性图

（5）下图是公告信息实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\公告信息.jpg](/md/blog.010.jpeg "C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\公告信息.jpg")
公告信息实体属性图

（6）下图是课程实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\课程.jpg](/md/blog.011.jpeg "C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\课程.jpg")
课程实体属性图

（7）下图是课程收藏实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\课程收藏.jpg](/md/blog.012.jpeg "C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\课程收藏.jpg")
课程收藏实体属性图

（8）下图是课程留言实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\课程留言.jpg](/md/blog.013.jpeg "C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\课程留言.jpg")
课程留言实体属性图
...
|3|kecheng\_uuid\_number|String|课程编号|是|
|4|kecheng\_name|String|课程名称|是|
|5|kecheng\_photo|String|课程照片|是|
|6|kecheng\_video|String|学习视频|是|
|7|kecheng\_types|Integer|课程类型|是|
|8|kecheng\_old\_money|BigDecimal|参考价格|是|
|9|kecheng\_clicknum|Integer|课程热度|是|
|10|zan\_number|Integer|赞|是|
|11|cai\_number|Integer|踩|是|
|12|kecheng\_content|String|课程介绍|是|
|13|kecheng\_delete|Integer|逻辑删除|是|
...
|2|kecheng\_id|Integer|课程|是|
|3|yonghu\_id|Integer|用户|是|
|4|xuexizuji\_time|Date|开始时间|是|
|5|xuexizuji\_types|Integer|学习状态|是|
...
|7|xuexi\_number|Integer|学习时长|是|
